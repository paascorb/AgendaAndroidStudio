            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (mEvent.isRecurring()) {
                    new AlertDialog.Builder(context)
                            .setTitle("Borrando Evento Periódico")
                            .setMessage("¿Estás seguro que deseas borrar este evento periódico? Todas las apariciones de este evento también se borrarán.")
