...
public class NewEventActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        repeatTextView.setText(sharedPreferences.getString("frequency", "Repetir una vez"));
    ...
    private boolean isRecurring(String toString) {
        return !toString.equals("Repetir una vez.");
    }
    ...
    private boolean confirmInputs() {
        ...
        if (!validateNotifications()) {
            Snackbar.make(addNotificationTextView, "No puedes poner notificaciones en el pasado.", BaseTransientBottomBar.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
